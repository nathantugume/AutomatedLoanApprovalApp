...
public class AdminTransactionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Admin Transactions");
        ...
        navigationView.setOnItemSelectedListener(item -> {
            if (item.getItemId() == R.id.bottom_manager_home){
                startActivity(new Intent(AdminTransactionActivity.this, AdminDashboardActivity.class));
                return true;
            }
            if (item.getItemId() == R.id.bottom_reports){
                startActivity(new Intent(AdminTransactionActivity.this, AdminReportActivity.class));
                return true;
            }
            if (item.getItemId() == R.id.bottom_mng_loan){
                startActivity(new Intent(AdminTransactionActivity.this, AdminManageLoanActivity.class));
                return true;
            }
            if (item.getItemId() == R.id.bottom_transactions){
                startActivity(new Intent(AdminTransactionActivity.this, AdminTransactionActivity.class));
                return true;
            }
            if (item.getItemId() == R.id.bottom_accounts){
                startActivity(new Intent(AdminTransactionActivity.this, UserActivity.class));
                return true;
            }
        ...
        firestoreCRUD.getAllDocuments("customer_details", task -> {
            if (task.isSuccessful()) {
                ...
                ArrayAdapter<String> adapter12 = new ArrayAdapter<>(AdminTransactionActivity.this, R.layout.menu_item, customers[0]);
            ...
            firestoreCRUD.queryDocuments("transaction", "userId", uid, new OnCompleteListener<QuerySnapshot>() {
                ...
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                    if (task.isSuccessful()) {
                        ...
                        ArrayAdapter<String> adapter1 = new ArrayAdapter<>(AdminTransactionActivity.this, R.layout.menu_item, ids[0]);
                ...
                firestoreCRUD.queryDocuments("Repayment", "transactionId", transactionId, new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(AdminTransactionActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });

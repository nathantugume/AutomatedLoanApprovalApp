...
public class AdminDisbursedLoansReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnItemSelectedListener(item -> {
            ...
            if (item.getItemId() == R.id.bottom_manager_home){
                startActivity(new Intent(AdminDisbursedLoansReport.this, AdminDashboardActivity.class));
                return true;
            }
            if (item.getItemId() == R.id.bottom_reports){
                startActivity(new Intent(AdminDisbursedLoansReport.this, AdminDisbursedLoansReport.class));
                return true;
            }
            if (item.getItemId() == R.id.bottom_mng_loan){
                startActivity(new Intent(AdminDisbursedLoansReport.this, AdminManageLoanActivity.class));
                return true;
            }
            if (item.getItemId() == R.id.bottom_transactions){
                startActivity(new Intent(AdminDisbursedLoansReport.this, AdminTransactionActivity.class));
                return true;
            }
            if (item.getItemId() == R.id.bottom_accounts){
                startActivity(new Intent(AdminDisbursedLoansReport.this, UserActivity.class));
                return true;
            }
            return false;
        });
